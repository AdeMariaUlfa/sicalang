            ...
            <div class="row">
              <div class="col-lg-3">
                <div class="features-item first-feature wow fadeInUp" data-wow-duration="1s" data-wow-delay="0s">
                  ...
                  <p>Buka website "SICALANG - Situs Candi di Malang"</p>
                </div>
              </div>
              <div class="col-lg-3">
                <div class="features-item second-feature wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s">
                  ...
                  <h4>Login</h4>
                  <div class="line-dec"></div>
                  <p>Pilih menu login, masukkan nama dan kelas kamu!</p>
                </div>
              </div>
              <div class="col-lg-3">
                <div class="features-item first-feature wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.4s">
                  ...
                  <h4>Pilih</h4>
                  <div class="line-dec"></div>
                  <p>Pilih candi yang ingin kamu pelajari atau ingin mengakses fitur virtual tour</p>
                </div>
              </div>
              <div class="col-lg-3">
